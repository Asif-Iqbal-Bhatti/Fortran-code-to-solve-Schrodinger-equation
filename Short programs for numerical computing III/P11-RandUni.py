...
for _ in range(1,nrnd+1):
    HistoBin(random(),a,b,x,y,n,1)
...
for _ in range(1,nrnd+1):
    HistoBin(randLCG1(1),a,b,x,y,n,1)
HistoBin(0e0,a,b,x,y,n,2)                               # normalize histogram
...
for _ in range(1,nrnd+1):
    HistoBin(randLCG2(1),a,b,x,y,n,1)
HistoBin(0e0,a,b,x,y,n,2)                               # normalize histogram
